...
Bei dem eingesetzten System handelt es sich um einen bipolaren Schrittmotor Abb. \ref{fig:stepper} mit vier Anschlussleitungen 
...
\subsection{Weiterer Ausbau des Prototyps} \label:{sec:microschalter }
\setauthor{Elisa Kaltenberger}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.2]{pics/microschalter.jpg}
